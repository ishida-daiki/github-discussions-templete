...
- **シームレスな投稿**: `Figma Design` や `FigJam`、`Dev Mode` から直接 GitHub Discussions にリクエスト、フィードバック、ディスカッションしたい内容を投稿できます。
  ...
  - *投稿例:* デザイン要素のスクリーンショットや、フィードバックの詳細などを GitHub Discussions にシームレスに投稿できます。
- **通知機能**: GitHub Discussions に新しい投稿が追加された場合、設定された`Slackチャンネル`にも自動的に通知が送信されます。これにより、チーム全体が最新のディスカッション内容を即座に把握できます。
